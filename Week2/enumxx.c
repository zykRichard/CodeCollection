...
{
    (__builtin_expect(!(argc > 1), 0) ? __assert_rtn(__func__, "enum.c", 11, "argc > 1") : (void)0);
...
void demo1()
{
    ...
    band = blue;
    (__builtin_expect(!(band == 4), 0) ? __assert_rtn(__func__, "enum.c", 36, "band == 4") : (void)0);


    band = orange;
    ++band;
    (__builtin_expect(!(band == yellow), 0) ? __assert_rtn(__func__, "enum.c", 41, "band == yellow") : (void)0);
    band = orange + red;
    (__builtin_expect(!(band == orange), 0) ? __assert_rtn(__func__, "enum.c", 43, "band == orange") : (void)0);
